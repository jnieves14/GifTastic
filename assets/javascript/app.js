...
function displayGif() {
    var shows = $(this).attr("data-title");
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + shows + "&api_key=BkaUZZWcFij6J7AoQj3WtPb1R2p9O6V9&limit=10";
    ...
    //EMPITES THE DIV HOLDING THE PREVIOUS GIF RESULTS
        ...
        for (var i = 0; i < response.data.length; i++) {
            ...
            var still = response.data[i].images.fixed_height_stil.url;
            //CREATING AN IMAGE TAG FOR THE SHOWS GIFS
            var showsImg = $("<img class='showsImage'>");
...
$("#resultsDiv").on("click", ".showsImage", function() {
